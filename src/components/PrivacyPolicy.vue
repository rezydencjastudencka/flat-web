      ...
      <v-flex xs12 sm12 md10>
        <v-card>
          <v-card-text>
            ...
            <p> maxmati built the Flat app as an Open Source app. This SERVICE is provided by
              maxmati at no cost and is intended for use as is.
            </p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and
              Conditions,
              which is
              accessible at Flat unless otherwise defined in this Privacy Policy.
            </p>
            <p><strong>Information Collection and Use</strong></p>
            <p>For a better experience, while using our Service, I may require you to provide us
              with
              certain
              ...
              User
              expenses, User
              revenues. The information that I request will be retained on your device and is not
              collected
              by me in any way.
            </p>
            ...
            <p> I want to inform you that whenever you use my Service, in a case of
              an error in the app I collect data and information (through third party products) on
              your
              phone
            ...
            <p> I value your trust in providing us your Personal Information, thus we are striving
              ...
              transmission over
              the internet, or method of electronic storage is 100% secure and reliable, and I
              cannot
              guarantee
            ...
            <p>This Service may contain links to other sites. If you click on a third-party link,
              ...
              will
              be directed
              to that site. Note that these external sites are not operated by me. Therefore, I
              strongly
